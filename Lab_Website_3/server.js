...
app.get('/player_info/post', function(req, res) {
  ...
  if (player_id != 'Select Player'){
    var query1 = 'select id, name from football_players;';
    var query2 = 'select img_src, year, major, passing_yards, rushing_yards, receiving_yards from football_players where id = ' + player_id + ';';
    var query3 = 'select count(*) from football_players inner join football_games on football_players.id = any(players) where football_players.id =' + player_id + ';';
